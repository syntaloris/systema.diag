...
> **Профессиональная веб-диагностика системы в минималистичном зелёном стиле.**

Полнофункциональное одностраничное веб-приложение для детального анализа параметров компьютера, браузера, сети и устройства — прямо в браузере, без установки.
...
open systema_diag.html        # macOS
xdg-open systema_diag.html    # Linux
start systema_diag.html         # Windows
```
...
```
Затем открой `http://localhost:8080/systema_diag.html`

### Как PWA (Progressive Web App)
1. Открой файл через HTTPS (или localhost)
2. В Chrome/Edge: меню → "Установить SYSTEMA.diag"
...
> Для получения **реальных температур, вольтажей, SMART дисков** — нужно нативное приложение (Python + `psutil` / `OpenHardwareMonitorLib`).

---

## 🎨 Дизайн

- **Цветовая схема:** тёмно-зелёная, минималистичная
- **Вдохновение:** [syl.nometa](https://syntaloris.github.io/syl.nometa/)
- **Шрифты:** Inter (UI), JetBrains Mono (моноширинный для данных)
- **Анимации:** плавные переходы, живые графики, пульсирующий индикатор статуса
...
**syntaloris** — [GitHub](https://github.com/syntaloris)

> *"Не пиши мета-сообщений. Просто покажи данные."*
